...
class NamesDataset(Dataset):
    ...
    def __create_tokens(self, vocab : Optional[vocab] = None):
        ...
        if vocab:
            ...
            self.vocab = build_vocab_from_iterator(self.names, specials=[NamesDataset.unk_token, NamesDataset.start_token, NamesDataset.stop_token, NamesDataset.padding_token])
